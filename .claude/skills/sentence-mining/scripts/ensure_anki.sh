...
# If Anki is closed — or, as it sometimes does, it crashes once during a
...
# -g: launch WITHOUT raising the window or activating the app — otherwise the Anki
# icon bounces in the Dock and takes focus in the middle of the user's work.
open -g -a Anki 2>/dev/null || true
